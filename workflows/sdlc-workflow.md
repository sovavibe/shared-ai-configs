...
Beads интеграция автоматически активируется при наличии директории `.beads/`:

| Условие              | Поведение                                                      |
| -------------------- | -------------------------------------------------------------- |
| `.beads/` существует | Полная интеграция: hooks синхронизируют beads автоматически    |
| `.beads/` отсутствует| Beads невидим: интеграция не активна                           |

### Настройка для разработчика

```bash
# Инициализация beads
bd init  # Создаёт .beads/ директорию
```

### Что происходит когда `.beads/` существует
